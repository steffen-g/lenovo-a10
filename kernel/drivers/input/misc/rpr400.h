...
/* define register for IC (rpr-400 registers) */
...
#define PS_ALS_SET_ALSPS_CONTROL  (LEDCURRENT_200MA | ALSGAIN_X128X128)
#define PS_ALS_SET_INTR_PERSIST   (3)
#define PS_ALS_SET_INTR           (PS_THH_ONLY | POLA_ACTIVEL | OUTPUT_LATCH | MODE_NONUSE)
#define PS_ALS_SET_PS_TH          (40)  // original is (200)		//(50)
...
#define RPR400IO		                    0xE1
#define ALSPS_SET_PS_MODE					_IOW(RPR400IO, 0x01, int)
#define ALSPS_GET_PS_MODE					_IOR(RPR400IO, 0x02, int)
#define ALSPS_GET_PS_DATA					_IOR(RPR400IO, 0x03, int)
#define ALSPS_GET_PS_RAW_DATA				_IOR(RPR400IO, 0x04, int)
#define ALSPS_SET_ALS_MODE					_IOW(RPR400IO, 0x05, int)
#define ALSPS_GET_ALS_MODE					_IOR(RPR400IO, 0x06, int)
#define ALSPS_GET_ALS_DATA					_IOR(RPR400IO, 0x07, int)
#define ALSPS_GET_ALS_RAW_DATA				_IOR(RPR400IO, 0x08, int)
