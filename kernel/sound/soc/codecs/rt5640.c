...
#include "rt56xx_ioctl.c"
#include "rt5640_ioctl.c"
...
static struct rt5640_init_reg init_list[] = {
	...
	{RT5640_CLS_D_OUT	, 0x9000},//8d[11] = 0'b
...
//	{RT5640_I2S1_SDP	, 0xD000},//change IIS1 and IIS2
	/*record*/
	{RT5640_IN1_IN2		, 0x5580},//IN1 boost 40db and differential mode
	{RT5640_IN3_IN4		, 0x0500},//IN2 boost 40db and signal ended mode
	{RT5640_REC_L2_MIXER	, 0x0079},//Mic1 -> RECMIXL && //Mic2 -> RECMIXL
	{RT5640_REC_R2_MIXER	, 0x0079},//Mic1 -> RECMIXR && //Mic2 -> RECMIXR
...
//	{RT5640_REC_R2_MIXER	, 0x006f},//Mic2 -> RECMIXR
	...
	//{RT5640_JD_CTRL	,      0x0000},//0x2bc0},//GPIO/IRQ    0x2bc0 low=hp high=spk     0x2e80 low=spk high=hp
...
static unsigned int rt5640_i2c_read(struct i2c_client *client,
				void *reg, int reglen,
...
static unsigned int rt5640_8_16_read_i2c(struct i2c_client *client,
					  unsigned int r)
{
	u8 reg = r;
	u16 data;
	...
	ret = rt5640_i2c_read(client, &reg, 1, &data, 2);
	if (ret < 0)
		return 0;
 ...
 */
static int rt5640_headset_detect(int jack_insert)
{
	int jack_type;
	int sclk_src;
	int reg63, reg64;
//	printk("rt5640_headset_detect..\n");
	if(jack_insert) {
		reg63 = snd_soc_read(rt5640_codec, RT5640_PWR_ANLG1);
		reg64 = snd_soc_read(rt5640_codec, RT5640_PWR_ANLG2);
		if (SND_SOC_BIAS_OFF == rt5640_codec->dapm.bias_level) {
			snd_soc_write(rt5640_codec, RT5640_PWR_ANLG1, 0xa814);
			snd_soc_write(rt5640_codec, RT5640_MICBIAS, 0x3830);
			snd_soc_write(rt5640_codec, RT5640_GEN_CTRL1 , 0x3701);
		}
		sclk_src = snd_soc_read(rt5640_codec, RT5640_GLB_CLK) &
			RT5640_SCLK_SRC_MASK;
		snd_soc_update_bits(rt5640_codec, RT5640_GLB_CLK,
			RT5640_SCLK_SRC_MASK, 0x3 << RT5640_SCLK_SRC_SFT);
		snd_soc_update_bits(rt5640_codec, RT5640_PWR_ANLG1,
			RT5640_PWR_LDO2, RT5640_PWR_LDO2);
		snd_soc_update_bits(rt5640_codec, RT5640_PWR_ANLG2,
			RT5640_PWR_MB1, RT5640_PWR_MB1);
		...
		snd_soc_update_bits(rt5640_codec, RT5640_GEN_CTRL1,
			0x1, 0x1);
		msleep(100);
		if (snd_soc_read(rt5640_codec, RT5640_IRQ_CTRL2) & 0x8)
		...
		snd_soc_update_bits(rt5640_codec, RT5640_GLB_CLK,
			RT5640_SCLK_SRC_MASK, sclk_src);
	//	snd_soc_write(rt5640_codec, RT5640_PWR_ANLG1, reg63);
	//	snd_soc_write(rt5640_codec, RT5640_PWR_ANLG2, reg64);
	} else {
		snd_soc_update_bits(rt5640_codec, RT5640_MICBIAS,
...
static int rt5640_hp_mic_switch(bool on)
{
//	printk("rt5640_mic_switch hp_type =%d\n",hp_type);
	if(on)
	{//inside 4
		snd_soc_update_bits(rt5640_codec, RT5640_REC_L2_MIXER,
			RT5640_M_BST1_RM_L | RT5640_M_BST2_RM_L, RT5640_M_BST1_RM_L | 0);		
		snd_soc_update_bits(rt5640_codec, RT5640_REC_R2_MIXER,
			RT5640_M_BST1_RM_R | RT5640_M_BST2_RM_R, RT5640_M_BST1_RM_R | 0);		
		snd_soc_update_bits(rt5640_codec, RT5640_PWR_ANLG2,
			RT5640_PWR_BST1 | RT5640_PWR_BST2, 0 | RT5640_PWR_BST2);
	}
	else
	{//
		snd_soc_update_bits(rt5640_codec, RT5640_REC_L2_MIXER,
			RT5640_M_BST1_RM_L | RT5640_M_BST2_RM_L, 0 | RT5640_M_BST2_RM_L);		
		snd_soc_update_bits(rt5640_codec, RT5640_REC_R2_MIXER,
			RT5640_M_BST1_RM_R | RT5640_M_BST2_RM_R, 0 | RT5640_M_BST2_RM_R);				
		snd_soc_update_bits(rt5640_codec, RT5640_PWR_ANLG2,
			RT5640_PWR_BST1 | RT5640_PWR_BST2, RT5640_PWR_BST1 | 0);
	}
...
static const char *rt5640_playback_path_mode[] = {"OFF", "RCV", "SPK", "HP", "HP_NO_MIC", "BT", "SPK_HP", //0-6
													"RING_SPK", "RING_HP", "RING_HP_NO_MIC", "RING_SPK_HP"};//7-10

static const SOC_ENUM_SINGLE_DECL(rt5640_path_type, 0, 0, rt5640_playback_path_mode);

static int rt5640_playback_path_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
	...
	ucontrol->value.integer.value[0] = rt5640->playback_path;
...
static int rt5640_playback_path_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
	...
	if (rt5640->playback_path == ucontrol->value.integer.value[0]){
		printk("%s:playback_path is not changed!\n",__func__);
		//return 0;
	}

	rt5640->playback_path = ucontrol->value.integer.value[0];
	printk("%s:set playback_path=%ld,hdmi %s\n",__func__,rt5640->playback_path,hdmi?"in":"out");
...
static const char *rt5640_capture_path_mode[] = {"MIC OFF", "Main Mic", "Hands Free Mic", "BT Sco Mic"};//

static const SOC_ENUM_SINGLE_DECL(rt5640_capture_type, 0, 0, rt5640_capture_path_mode);

static int rt5640_capture_path_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
	...
	ucontrol->value.integer.value[0] = rt5640->capture_path;

	return 0;
}

static int rt5640_capture_path_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);

	if (rt5640->capture_path == ucontrol->value.integer.value[0]){
		printk("%s:capture_path is not changed!\n",__func__);
		//return 0;
	}

	rt5640->capture_path = ucontrol->value.integer.value[0];
	printk("%s:set capture_path=%ld\n",__func__,rt5640->capture_path);
	switch (rt5640->capture_path) {
	case MIC_OFF:
		#if SWITCH_REGESTER_DIRECT//*
		snd_soc_update_bits(rt5640_codec, RT5640_REC_L2_MIXER,
			RT5640_M_BST1_RM_L | RT5640_M_BST2_RM_L, RT5640_M_BST1_RM_L | RT5640_M_BST2_RM_L);//bit1 = main mic, bit2 = headset mic;		
		snd_soc_update_bits(rt5640_codec, RT5640_REC_R2_MIXER,
			RT5640_M_BST1_RM_R | RT5640_M_BST2_RM_R, RT5640_M_BST1_RM_R | RT5640_M_BST2_RM_R);		
		snd_soc_update_bits(rt5640_codec, RT5640_PWR_ANLG2,
			RT5640_PWR_BST1 | RT5640_PWR_BST2, 0 | 0);
		#else//*/
...
static const SOC_ENUM_SINGLE_DECL(
	rt5640_in3_mode_enum, RT5640_IN1_IN2,
	RT5640_IN_SFT2, rt5640_input_mode);
...
static const struct snd_kcontrol_new rt5640_snd_controls[] = {
	...
	SOC_ENUM_EXT("Playback Path", rt5640_path_type,
		rt5640_playback_path_get, rt5640_playback_path_put),
		
	SOC_ENUM_EXT("Capture MIC Path", rt5640_capture_type,
		rt5640_capture_path_get, rt5640_capture_path_put),
...
static DEVICE_ATTR(codec_reg, 0660, rt5640_codec_show, rt5640_codec_store);
...
static int rt5640_probe(struct snd_soc_codec *codec)
{
	...
	codec_ex_fun.codec_headset_detect = rt5640_headset_detect;
	//codec_ex_fun.codec_mic_switch = rt5640_hp_mic_switch;
#endif
		    ...
		    const struct i2c_device_id *id)
{
	...
	int ret;
	u8 data[3];
	int value;// = RT5640_RESET;//RT5640_VENDOR_ID;
	...
	if (ret < 0)
		printk("%s:send i2c reg[RT5640_RESET]=0 failed!\n",__func__);
	
	data[0] = RT5640_GEN_CTRL2;
    ...
    value = rt5640_8_16_read_i2c(i2c, 0x00);
    printk("%s:rt5640 driver sw reset & device id register=0x%x, device_id=0x%x\n", __func__, value, (value >> 1) & 0x03);
    if(((value >> 1) & 0x03) != 0x03) {
        goto no_rt5640;
    }
    printk("%s:rt5640 recognize itself.\n",__func__);
#if 0
	value = rt5640_8_16_read_i2c(i2c,RT5640_VENDOR_ID);
	printk("%s:rt5640 driver chip id = %d\n",__func__,value);
