...
#if defined(CONFIG_HDMI) && defined(CONFIG_SOUND_EX_FUN)
	extern int hdmi_is_insert(void);
	extern void codec_set_spk(bool on);         
	if(hdmi_is_insert()) {                 
		if(codec_ex_fun.codec_set_spk)
			codec_ex_fun.codec_set_spk(on);
	}
#endif

#if defined(CONFIG_HDMI_RK30) && defined(CONFIG_SOUND_EX_FUN)
	extern int hdmi_get_hotplug(void);
	if(hdmi_get_hotplug() == 2/*HDMI_HPD_ACTIVED*/) {
		if(codec_ex_fun.codec_set_spk)
			codec_ex_fun.codec_set_spk(false);
	}
#endif
...
static struct snd_soc_dai_link rk29_dai[] = {
	{
		.name = "RealTek I2S1",//"RT5640 I2S1",
		.stream_name = "RealTek PCM",//"RT5640 PCM",
		.codec_name = "rt5640.4-001c",//"rt5640.0-001c",
		.platform_name = "rockchip-audio",
			...
			.cpu_dai_name = "rk29_i2s.1",
		#endif
		.codec_dai_name = "RealTek-aif1",//"rt5640-aif1",
		.init = rk29_rt3261_init,
		.ops = &rk29_ops,
	},
	{
		.name = "RealTek I2S2",//"RT5640 I2S2",
		.stream_name = "RealTek PCM",//"RT5640 PCM",
		.codec_name = "rt5640.4-001c",//"rt5640.0-001c",
		.platform_name = "rockchip-audio",
		#if defined(CONFIG_SND_RK29_SOC_I2S_8CH)    
			...
			.cpu_dai_name = "rk29_i2s.1",
		#endif 
		.codec_dai_name = "RealTek-aif2",//"rt5640-aif2",
