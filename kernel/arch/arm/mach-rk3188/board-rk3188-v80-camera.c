...
#include <linux/platform_data/leds-lm3642.h> // for camera flash lamp
#else	
#include <linux/platform_data/leds-lm2759.h> // for camera flash lamp
#endif
...
#define CONFIG_SENSOR_RESET_PIN_0		  INVALID_GPIO//fixed bitland  RK30_PIN0_PB1
#define CONFIG_SENSOR_POWERDN_PIN_0 	  RK30_PIN3_PB4//RK30_PIN3_PB5
#define CONFIG_SENSOR_FALSH_PIN_0		 RK30_PIN0_PC3//INVALID_GPIO
#define CONFIG_SENSOR_POWERACTIVE_LEVEL_0 RK29_CAM_POWERACTIVE_L//no used
#define CONFIG_SENSOR_RESETACTIVE_LEVEL_0 RK29_CAM_RESETACTIVE_H
#define CONFIG_SENSOR_POWERDNACTIVE_LEVEL_0 RK29_CAM_POWERDNACTIVE_H
#define CONFIG_SENSOR_FLASHACTIVE_LEVEL_0 RK29_CAM_FLASHACTIVE_H

#define CONFIG_SENSOR_QCIF_FPS_FIXED_0		15000//176X144
...
static struct lm3642_platform_data lm3642_info = {
	...
	.strobe_pin = 0x20,
	.tx_pin = 0x00,
	.gpio_strobe =CONFIG_SENSOR_FALSH_PIN_0,
	.gpio_torch =RK30_PIN0_PC2,
	.strobe_active=GPIO_HIGH,
	.torch_active =GPIO_HIGH,	
};
 #endif

#ifdef CONFIG_LEDS_LM2759
static struct lm2759_platform_data lm2759_info = {
	.torch_pin = 0x10,
	.strobe_pin = 0x20,
	.tx_pin = 0x00,
	.gpio_strobe =CONFIG_SENSOR_FALSH_PIN_0,
