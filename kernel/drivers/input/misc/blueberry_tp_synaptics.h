/*
 * Blueberry Synaptics touchpad driver.
 *
...
#ifndef _BLUEBERRY_TP_SYNAPTICS_H
#define _BLUEBERRY_TP_SYNAPTICS_H
...
struct synaptics_data {
	...
	/* add to accommadate i2c */
	struct i2c_client *client;
	/* for future modification of two modes */
