...
*       All customer should change this for your own project
*		O2micro don't check the correctness for this file.
* 		So you may need check it carefully.
*   
...
#include "parameter.h"
#define VERSION		   "2012.9.25/2.00.03"	
...
{
	printk("uuuuuuuuuuuuuuuuuuuuu OZ8806 remove");
