...
#include <sound/tlv.h>
#include "../../../drivers/headset_observe/sound_external_fun.h"
...
#include "rt_codec_ioctl.c"
#include "rt3261_ioctl.c"
...
static unsigned int rt3261_i2c_read(struct i2c_client *client,
				void *reg, int reglen,
...
static unsigned int rt3261_8_16_read_i2c(struct i2c_client *client,
					  unsigned int r)
{
	u8 reg = r;
	u16 data;
	...
	ret = rt3261_i2c_read(client, &reg, 1, &data, 2);
	if (ret < 0)
		return 0;
...
static int do_playback_path_put(struct snd_soc_codec *codec);
static void codec_set_spk(bool on)
{
	...
	printk("codec set spk %d \n",on);
	if(on){
		DBG("snd_soc_dapm_enable_pin\n");
		do_playback_path_put(codec);
		atomic_set(&hdmi_flag,0);
	}else{
		atomic_set(&hdmi_flag,1);
...
static struct rt3261_init_reg init_list[] = {
	...
	{RT3261_CLS_D_OUT	, 0x9000},//8d[11] = 0'b
	...
	/*playback*/
	{RT3261_STO_DAC_MIXER	, 0x1414},//Dig inf 1 -> Sto DAC mixer -> DACL
	{RT3261_OUT_L3_MIXER	, 0x01fe},//DACL1 -> OUTMIXL
	{RT3261_OUT_R3_MIXER	, 0x01fe},//DACR1 -> OUTMIXR
	{RT3261_HP_VOL		, 0x8888},//OUTMIX -> HPVOL
	{RT3261_HPO_MIXER	, 0xc000},//HPVOL -> HPOLMIX
//	{RT3261_HPO_MIXER	, 0xa000},//DAC1 -> HPOLMIX
	{RT3261_CHARGE_PUMP	, 0x0f00},
	{RT3261_PRIV_INDEX	, 0x0090},
	{RT3261_PRIV_DATA	, 0x2000},
	{RT3261_PRIV_INDEX	, 0x0091},
	{RT3261_PRIV_DATA	, 0x1000},
//	{RT3261_HP_CALIB_AMP_DET, 0x0420},
	{RT3261_SPK_L_MIXER	, 0x0036},//DACL1 -> SPKMIXL
	{RT3261_SPK_R_MIXER	, 0x0036},//DACR1 -> SPKMIXR
	{RT3261_SPK_VOL		, 0x8b8b},//SPKMIX -> SPKVOL
	{RT3261_SPO_CLSD_RATIO	, 0x0004},
	{RT3261_SPO_L_MIXER	, 0xe800},//SPKVOLL -> SPOLMIX
	{RT3261_SPO_R_MIXER	, 0x2800},//SPKVOLR -> SPORMIX
//	{RT3261_SPO_L_MIXER	, 0xb800},//DAC -> SPOLMIX
//	{RT3261_SPO_R_MIXER	, 0x1800},//DAC -> SPORMIX  
//	{RT3261_I2S1_SDP	, 0xD000},//change IIS1 and IIS2
	/*record*/
	{RT3261_IN1_IN2		, 0x5580},//IN1 boost 40db and differential mode
	{RT3261_IN3_IN4		, 0x0500},//IN2 boost 40db and signal ended mode
	{RT3261_REC_L2_MIXER	, 0x007d},//Mic1 -> RECMIXL
	{RT3261_REC_R2_MIXER	, 0x007d},//Mic1 -> RECMIXR
//	{RT3261_REC_L2_MIXER	, 0x006f},//Mic2 -> RECMIXL
//	{RT3261_REC_R2_MIXER	, 0x006f},//Mic2 -> RECMIXR
	{RT3261_STO_ADC_MIXER	, 0x3020},//ADC -> Sto ADC mixer
#if RT3261_DET_EXT_MIC
	{RT3261_MICBIAS		, 0x3800},/* enable MICBIAS short current */
	{RT3261_GPIO_CTRL1	, 0x8400},/* set GPIO1 to IRQ */
	{RT3261_GPIO_CTRL3	, 0x0004},/* set GPIO1 output */
	{RT3261_IRQ_CTRL2	, 0x8000},/*set MICBIAS short current to IRQ */
...
void rt3261_hp_switch(bool on)//bool hp_type)
{
	if(on) {// headphone
		snd_soc_update_bits(rt3261_codec, RT3261_SPK_VOL,
				RT3261_L_MUTE | RT3261_R_MUTE,
				RT3261_L_MUTE | RT3261_R_MUTE);
		snd_soc_update_bits(rt3261_codec, RT3261_SPK_VOL,
				RT3261_VOL_L_MUTE | RT3261_VOL_R_MUTE,
				RT3261_VOL_L_MUTE | RT3261_VOL_R_MUTE);
		snd_soc_update_bits(rt3261_codec, RT3261_HP_VOL,
				RT3261_L_MUTE | RT3261_R_MUTE, 0);
		snd_soc_update_bits(rt3261_codec, RT3261_HP_VOL,
				RT3261_VOL_L_MUTE | RT3261_VOL_R_MUTE, 0);
...
int rt3261_hp_mic_switch(bool on)//bool hp_type)
{
	printk("%s on =%d\n",__func__,on);

	if(on)
	{//inside 4
		snd_soc_update_bits(rt3261_codec, RT3261_REC_L2_MIXER,
			RT3261_M_BST2_RM_L, 0);		
		snd_soc_update_bits(rt3261_codec, RT3261_REC_R2_MIXER,
			RT3261_M_BST2_RM_R, 0);	
		snd_soc_update_bits(rt3261_codec, RT3261_REC_L2_MIXER,
	...
	{//
		snd_soc_update_bits(rt3261_codec, RT3261_REC_L2_MIXER,
			RT3261_M_BST2_RM_L, RT3261_M_BST2_RM_L);		
		snd_soc_update_bits(rt3261_codec, RT3261_REC_R2_MIXER,
			RT3261_M_BST2_RM_R, RT3261_M_BST2_RM_R);	
		snd_soc_update_bits(rt3261_codec, RT3261_REC_L2_MIXER,
...
static const char *rt3261_playback_path_mode[] = {"OFF", "RCV", "SPK", "HP", "HP_NO_MIC", "BT", "SPK_HP", //0-6
													"RING_SPK", "RING_HP", "RING_HP_NO_MIC", "RING_SPK_HP"};//7-10

static const SOC_ENUM_SINGLE_DECL(rt3261_path_type, 0, 0, rt3261_playback_path_mode);

static int rt3261_playback_path_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt3261_priv *rt3261 = snd_soc_codec_get_drvdata(codec);
	...
	ucontrol->value.integer.value[0] = rt3261->playback_path;
...
static int do_playback_path_put(struct snd_soc_codec *codec)
{
	...
	default:
		printk("%s:unknow playback_path=%d\n",__func__, rt3261->playback_path);	
		mutex_unlock(&codec->mutex);
		return -EINVAL;
	}
	mutex_unlock(&codec->mutex);
...
static int rt3261_playback_path_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt3261_priv *rt3261 = snd_soc_codec_get_drvdata(codec);
	int hdmi = atomic_read(&hdmi_flag);

	if (rt3261->playback_path == ucontrol->value.integer.value[0]){
		printk("%s:playback_path is not changed!\n",__func__);
		//return 0;
	}

	rt3261->playback_path = ucontrol->value.integer.value[0];
	printk("%s:set playback_path=%ld,hdmi %s\n",__func__,rt3261->playback_path,hdmi?"in":"out");
...
static const char *rt3261_capture_path_mode[] = {"MIC OFF", "Main Mic", "Hands Free Mic", "BT Sco Mic"};//

static const SOC_ENUM_SINGLE_DECL(rt3261_capture_type, 0, 0, rt3261_capture_path_mode);

static int rt3261_capture_path_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt3261_priv *rt3261 = snd_soc_codec_get_drvdata(codec);
	...
	ucontrol->value.integer.value[0] = rt3261->capture_path;

	return 0;
}

static int rt3261_capture_path_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt3261_priv *rt3261 = snd_soc_codec_get_drvdata(codec);

	if (rt3261->capture_path == ucontrol->value.integer.value[0]){
		printk("%s:capture_path is not changed!\n",__func__);
		//return 0;
	}

	rt3261->capture_path = ucontrol->value.integer.value[0];
	printk("%s:set capture_path=%ld\n",__func__,rt3261->capture_path);
	switch (rt3261->capture_path) {
	case MIC_OFF:
		#if SWITCH_REGESTER_DIRECT//*
		snd_soc_update_bits(rt3261_codec, RT3261_REC_L2_MIXER,
			RT3261_M_BST1_RM_L | RT3261_M_BST2_RM_L, RT3261_M_BST1_RM_L | RT3261_M_BST2_RM_L);//bit1 = main mic, bit2 = headset mic;		
		snd_soc_update_bits(rt3261_codec, RT3261_REC_R2_MIXER,
			RT3261_M_BST1_RM_R | RT3261_M_BST2_RM_R, RT3261_M_BST1_RM_R | RT3261_M_BST2_RM_R);		
		snd_soc_update_bits(rt3261_codec, RT3261_PWR_ANLG2,
			RT3261_PWR_BST1 | RT3261_PWR_BST2, 0 | 0);
		#else//*/
	...
	case Main_Mic:
		...
		snd_soc_update_bits(codec, RT3261_REC_L2_MIXER, 
			RT3261_M_BST1_RM_L | RT3261_M_BST2_RM_L, 0 | RT3261_M_BST2_RM_L);
		snd_soc_update_bits(codec, RT3261_REC_R2_MIXER,
			RT3261_M_BST1_RM_R | RT3261_M_BST2_RM_R, 0 | RT3261_M_BST2_RM_R);
		snd_soc_update_bits(rt3261_codec, RT3261_PWR_ANLG2,
			RT3261_PWR_BST1 | RT3261_PWR_BST2, RT3261_PWR_BST1 | 0);
		#else//*/
		snd_soc_dapm_disable_pin(&codec->dapm, "Headset Jack");
	...
	case Hands_Free_Mic:
		#if SWITCH_REGESTER_DIRECT//*
		snd_soc_update_bits(rt3261_codec, RT3261_REC_L2_MIXER,
			RT3261_M_BST1_RM_L | RT3261_M_BST2_RM_L, RT3261_M_BST1_RM_L | 0);		
		snd_soc_update_bits(rt3261_codec, RT3261_REC_R2_MIXER,
			RT3261_M_BST1_RM_R | RT3261_M_BST2_RM_R, RT3261_M_BST1_RM_R | 0);		
		snd_soc_update_bits(rt3261_codec, RT3261_PWR_ANLG2,
			RT3261_PWR_BST1 | RT3261_PWR_BST2, 0 | RT3261_PWR_BST2);
		#else//*/
		snd_soc_dapm_disable_pin(&codec->dapm, "Mic Jack");
...
static const struct snd_kcontrol_new rt3261_snd_controls[] = {
	...
	SOC_ENUM_EXT("Playback Path", rt3261_path_type,
		rt3261_playback_path_get, rt3261_playback_path_put),
		
	SOC_ENUM_EXT("Capture MIC Path", rt3261_capture_type,
		rt3261_capture_path_get, rt3261_capture_path_put),
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		rt3261_index_update_bits(codec, RT3261_CHOP_DAC_ADC, 0x1000, 0x1000);
	...
	case SND_SOC_DAPM_POST_PMD:
		snd_soc_update_bits(codec, RT3261_GEN_CTRL1,
			...
			RT3261_M_MAMIX_L | RT3261_M_MAMIX_R);
		rt3261_index_update_bits(codec, RT3261_CHOP_DAC_ADC, 0x1000, 0x0000);
		break;
	...
	if(on) {
		if(hp_amp_power_count <= 0) {
			...
			snd_soc_update_bits(codec, RT3261_DEPOP_M2,
				RT3261_DEPOP_MASK, RT3261_DEPOP_MAN);//reg8f[13] 1
			snd_soc_update_bits(codec, RT3261_DEPOP_M1,
				RT3261_HP_CP_MASK | RT3261_HP_SG_MASK | RT3261_HP_CB_MASK,
				RT3261_HP_CP_PU | RT3261_HP_SG_DIS | RT3261_HP_CB_PU);//reg8e[3,2,1] 1
			rt3261_index_write(codec, RT3261_HP_DCC_INT1, 0x9f00);//index77
			/* headphone amp power on */
			snd_soc_update_bits(codec, RT3261_PWR_ANLG1,
				RT3261_PWR_FV1 | RT3261_PWR_FV2 , 0);//reg63[14,3] 0
			snd_soc_update_bits(codec, RT3261_PWR_VOL,
				RT3261_PWR_HV_L | RT3261_PWR_HV_R,
				RT3261_PWR_HV_L | RT3261_PWR_HV_R);//reg66[11,10] 1
			snd_soc_update_bits(codec, RT3261_PWR_ANLG1,
				RT3261_PWR_HP_L | RT3261_PWR_HP_R | RT3261_PWR_HA | RT3261_PWR_LM,
				RT3261_PWR_HP_L | RT3261_PWR_HP_R | RT3261_PWR_HA | RT3261_PWR_LM);//reg63[12,7,6,5] 1
			msleep(50);
			snd_soc_update_bits(codec, RT3261_PWR_ANLG1,
				RT3261_PWR_FV1 | RT3261_PWR_FV2,
				RT3261_PWR_FV1 | RT3261_PWR_FV2);//reg63[14,3] 1
				
			snd_soc_update_bits(codec, RT3261_CHARGE_PUMP,
				RT3261_PM_HP_MASK, RT3261_PM_HP_HV);//reg91  0200
			//rt3261_index_update_bits(codec, RT3261_CHOP_DAC_ADC, 0x0200, 0x0200);//index3d
			snd_soc_update_bits(codec, RT3261_DEPOP_M1,
				RT3261_HP_CO_MASK | RT3261_HP_SG_MASK,
				RT3261_HP_CO_EN | RT3261_HP_SG_EN);//reg8e[4,2] 1
		}
		hp_amp_power_count++;
	} else {
		hp_amp_power_count--;
		if(hp_amp_power_count <= 0) {
			//rt3261_index_update_bits(codec, RT3261_CHOP_DAC_ADC, 0x0200, 0x0);// index3d
			snd_soc_update_bits(codec, RT3261_DEPOP_M1,
				RT3261_HP_SG_MASK | RT3261_HP_L_SMT_MASK |
				RT3261_HP_R_SMT_MASK, RT3261_HP_SG_DIS |
				RT3261_HP_L_SMT_DIS | RT3261_HP_R_SMT_DIS);//reg8e[4,2] 1
			...
			snd_soc_update_bits(codec, RT3261_DEPOP_M1,
				...
				RT3261_HP_SG_EN | RT3261_HP_CB_PD);//reg8e[15,7,4,3,2,1,] 1
			snd_soc_update_bits(codec, RT3261_PWR_ANLG1,
				RT3261_PWR_HP_L | RT3261_PWR_HP_R | RT3261_PWR_HA | RT3261_PWR_LM,
				0);//reg63[12,7,6,5] 0
		}
...
static void rt3261_pmu_depop(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, RT3261_DEPOP_M3,
		...
		(RT3261_CP_FQ_192_KHZ << RT3261_CP_FQ3_SFT));//reg90[8,4,7] 1
	rt3261_index_write(codec, RT3261_MAMP_INT_REG2, 0xfc00);//index37
	snd_soc_update_bits(codec, RT3261_DEPOP_M1,
		RT3261_SMT_TRIG_MASK, RT3261_SMT_TRIG_EN);//8e[15] 1
	snd_soc_update_bits(codec, RT3261_DEPOP_M1,
		RT3261_RSTN_MASK, RT3261_RSTN_EN);//8e[6] 1
	snd_soc_update_bits(codec, RT3261_DEPOP_M1,
		RT3261_RSTN_MASK | RT3261_HP_L_SMT_MASK | RT3261_HP_R_SMT_MASK,
		RT3261_RSTN_DIS | RT3261_HP_L_SMT_EN | RT3261_HP_R_SMT_EN);//8e[6,9,8] 1
	...
	snd_soc_update_bits(codec, RT3261_DEPOP_M1,
		RT3261_HP_SG_MASK | RT3261_HP_L_SMT_MASK |
		RT3261_HP_R_SMT_MASK, RT3261_HP_SG_DIS |
		RT3261_HP_L_SMT_DIS | RT3261_HP_R_SMT_DIS);//8e[2,9,8] 0
	msleep(20);	
	snd_soc_update_bits(codec, RT3261_HP_CALIB_AMP_DET,
		RT3261_HPD_PS_MASK, RT3261_HPD_PS_EN);//d6[5] 1
}
			...
			enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_OFF:
		...
		snd_soc_write(codec, RT3261_PWR_ANLG2, 0x0800);
		break;
...
#ifdef CONFIG_SOUND_EX_FUN
	codec_ex_fun.codec_set_spk = codec_set_spk;
	//codec_ex_fun.codec_set_hp = rt3261_hp_switch;
	//codec_ex_fun.codec_mic_switch = rt3261_hp_mic_switch;
#endif
		    ...
		    const struct i2c_device_id *id)
{
	...
	int ret;
	u8 data[3];
	int value;// = RT3261_RESET;//RT3261_VENDOR_ID;
	
	data[0] = RT3261_RESET;
	data[1] = 0;
	data[2] = 0;
	ret = i2c_master_normal_send(i2c, data, 3,400*1000);
	if (ret < 0)
		printk("%s:send i2c reg[RT3261_RESET]=0 failed!\n",__func__);
	
	data[0] = RT3261_GEN_CTRL2;
	data[1] = (0x4040 >> 8) & 0xff;//value=0x4040
	data[2] = 0x4040 & 0xff;
	ret = i2c_master_normal_send(i2c, data, 3,400*1000);
	if (ret < 0)
		printk("%s:send i2c reg[RT3261_GEN_CTRL2]=0 failed!\n",__func__);

    value = rt3261_8_16_read_i2c(i2c, 0x00);
	printk("%s:rt3261-mid driver sw reset & device id register=0x%x, device_id=0x%x\n", __func__, value, (value >> 1) & 0x03);
	if(((value >> 1) & 0x03) != 0x02) {
		goto no_rt3261;
	}
	printk("%s:rt3261_mid recognize itself.\n",__func__);
#if 0
	value = rt3261_8_16_read_i2c(i2c,RT3261_VENDOR_ID);
	printk("%s:rt3261-mid driver chip id = 0x%0x\n",__func__,value);
	if( (0x5!=value) && (0x3!=value) ) {
	//if(0x6!=value) {
		goto no_rt3261;
	}
#endif
