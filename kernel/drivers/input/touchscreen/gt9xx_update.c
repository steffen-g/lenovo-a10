 ...
 *      V1.4:2012/12/12,add config auto update function,modify enter_update_mode,add update file cal checksum
 */
...
#define GUP_SEARCH_FILE_TIMES       16 //50
#define UPDATE_FILE_PATH_2          "/data/goodix/_goodix_update_.bin"
#define UPDATE_FILE_PATH_1          "/sdcard/goodix/_goodix_update_.bin"

#define CONFIG_FILE_PATH_1          "/data/goodix/_goodix_config_.cfg"
#define CONFIG_FILE_PATH_2          "/sdcard/goodix/_goodix_config_.cfg"
...
s32 gup_update_proc(void *dir)
{
    ...
    if(guitar_client == NULL)                       //support apk update
    {
        guitar_client = i2c_connect_client;
    }
    ts = i2c_get_clientdata(guitar_client);
    
    ret = gup_check_update_file(guitar_client, &fw_head, (u8*)dir);     //20121211
    if(FAIL == ret)
    {
