...
*/
#if defined(CONFIG_MTK_COMBO_DRIVER_VERSION_JB2) || defined(CONFIG_RTL8723AS)
...
#else
#define RK29_MAX_SDIO_FREQ   50000000    //set max-sdio-frequency 25Mhz at the present time
#endif
